...
q2.prepare("SELECT * FROM EMPLOYES WHERE SALAIRE=<1500");
q2.exec();

q3.prepare("SELECT * FROM EMPLOYES WHERE SALAIRE>=1500");
q3.exec();
...
// Assign names to the set of bars used
        QBarSet *set0 = new QBarSet("=<1500");
        QBarSet *set1 = new QBarSet(">=1500 ");
...
//pie chart
   ...
   // c3=c3/tot;
    ...
    series->append("under 1500",c1);
    series->append("over 1500",c2);
